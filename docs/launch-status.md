...
- Next external action: submit individual Search Console priority recrawl requests for the three changed canonical URLs after action-time approval. Do not resubmit any of the four URLs already recovered in the September 8–9 batch.
